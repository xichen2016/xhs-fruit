	...
	$.fn.extend({
						...
						if (!container.hasClass("revslider-initialised")) {
									...
									container.find('.tp-caption iframe').each(function(i) {
										try {
												...
												if ($(this).attr('src').indexOf('you')>0 && addedyt==0) {
													addedyt=1;
									 ...
									 container.find('.tp-caption iframe').each(function(i) {
										try{
												if ($(this).attr('src').indexOf('vim')>0 && addedvim==0) {
													addedvim=1;
									...
									container.find('.tp-caption video').each(function(i) {
										try{
												if ($(this).hasClass('video-js') && addedvid==0) {
													addedvid=1;
													var f = document.createElement("script");
		...
		function swapSlideProgress(container,opt) {
			...
			if (actli.index() != nextli.index()) {
				...
				//alert(actli.index()+"  "+nextli.index());
			}
			animateTheCaptions(nextli, opt);
										...
										if (nextcaption.hasClass("randomrotate") && (opt.ie || opt.ie9)) nextcaption.removeClass("randomrotate").addClass("sfb");
										   ...
										   var imh = 0;
											...
											if (nextcaption.data('x')=="right" || nextcaption.data('xright')=='right') {
												...
												nextcaption.data('x',(crw - nextcaption.outerWidth(true))/xbw+hofs);
											}
											...
											if (nextcaption.data('y')=="bottom" || nextcaption.data('ybottom')=='bottom') {
												...
												nextcaption.data('y',(crh - nextcaption.outerHeight(true))/opt.bh+vofs);
											}
											...
											nextcaption.data('timer',setTimeout(function() {
														...
														)
													{
														...
														nextcaption.animate({'opacity':1,'left':(xbw*nextcaption.data('x')+offsetx)+'px','top':opt.bh*(nextcaption.data('y'))+offsety+"px"},{duration:nextcaption.data('speed'), easing:easetype,complete:function() { if (opt.ie) $(this).addClass('noFilterClass');}});
														//if (opt.ie) nextcaption.addClass('noFilterClass');
													}
											},nextcaption.data('start')));
