...
class RokSprocketViewModule extends RokSprocketLegacyJView
{
	...
	protected function compileLess()
	{
		...
		RokCommon_Header::addStyle(JURI::base(true) . '/components/com_roksprocket/assets/styles/roksprocket.css?nocache=2.0.6');
	}
	...
	protected function compileJS()
	{
		...
		RokCommon_Header::addScript(JURI::base(true) . '/components/com_roksprocket/assets/js/roksprocket.js?nocache=2.0.6');
